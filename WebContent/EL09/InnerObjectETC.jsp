...
<body>
	<fieldset>
		...
		<!-- JSP의 pageContext내장객체와 같다.단,
		 ...
		 ${pageContext.request.session.maxInactiveInterval }초
		 ...
		 %>
		  ...
		  <!-- 
		   ...
		   <h6>JSTL 미 사용</h6>
			\${elList[0] } : ${elList[0] }
			<ul>
				<li>이름:${elList[0].name},아이디:${elList[0].id},아이디:${elList[0].pwd}</li>
				<li>이름:${elList[1].name},아이디:${elList[1].id},아이디:${elList[1].pwd}</li>
			</ul>
			<h6>JSTL 사용</h6>
			<ul>
