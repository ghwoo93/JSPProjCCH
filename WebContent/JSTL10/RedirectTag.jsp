...
<!-- RedirectTag.jsp -->   
 <!-- 
	...
	절대경로로 설정시 url속성에 역시
	컨텍스트 루트 제외
	단,JSP내장객체의 response의
	sendRedirect()로 이동시에는 컨텍스트 루트 포함
 -->
<!-- 리퀘스트 영역에 속성 저장 -->
<c:set var="requestvar" scope="request" value="리퀘스트 영역"/> 
<!-- 자바코드로 리다이렉트 -->
<%--
...
<!-- 다른 어플리케이션안에 있는 페이지로 redirect 
 ...
 <c:redirect url="/Index.jsp" context="/TestProj">
 	<c:param name="user" value="PARK1234"/>
	<c:param name="pass" value="79791234"/>
 </c:redirect>
--%>
