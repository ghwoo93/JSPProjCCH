...
<%
	...
	*/
	...
	//3-4]파일명이 중복된 경우 파일명을 재정의하도록 FileRenamePolicy객체 얻기(인덱스가 자동으로 부여된다.)
	...
	//아래2줄은 값 어떻게 받고있는지 확인하기 위한 test
...
<body>
	<fieldset>
		...
		<ul style="list-style: upper-roman;">
			...
			%>
			<li>
				<img src="<c:url value='/Upload'/>/<%=filename %>" alt="이미지" style="width:200px;height:200px"/>
			</li>
			<% } %>
		</ul>
