...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<c:url value='/DataRoom/Edit.kosmo'/>">
					...
					<div class="form-group"><!-- <div class="row">와 같다 -->
						...
						<div class="col-sm-4">
							<input value="${dto.name}" type="text" class="form-control" name="name" placeholder="이름을 입력하세요?">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">제목</label>
						<div class="col-sm-4">
							<input value="${dto.title}" type="text" class="form-control" name="title" placeholder="제목을 입력하세요?" >
						</div>
					</div>
					<div class="form-group">
