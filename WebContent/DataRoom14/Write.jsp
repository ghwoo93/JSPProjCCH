...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<c:url value='/DataRoom/Write.kosmo'/>">
		...
		$(function(){
			...
			$('form').on('submit',function(){
				...
				if($(this).get(0).attachFile.value==""){
					...
					if($(this).get(0).attachFile.files[0].size > 500*1024){
